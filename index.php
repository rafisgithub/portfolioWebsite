...
<head>
    ...
    <title>Rafi Ahmed's Portfolio</title>
...
<body>
    ...
    <nav class="navbar">
        <div class="max-width">
            <div class="logo"><a href="#">RAfI <span>AHMED</span></a></div>
            <ul class="menu">
    ...
    <section class="home" id="home">
        <div class="max-width">
            <div class="home-content">
                ...
                <div class="text-2">Rafi Ahmed</div>
                <div class="text-3">And I'm a <span class="typing"></span></div>
                <a href="mailto:smrafi120@gmail.com" target="_blank" >Hire me</a>
                <a href="https://github.com/rafisgithub" target="_blank">Git Hub</a>
                <a href="https://www.linkedin.com/in/rafi-ahmed-439585216/" target="_blank">Linkedin</a>
            </div>
        </div>
    </section>
        ...
        <div class="max-width">
            ...
            <div class="about-content">
                <div class="column left">
                    <img src="images/rafi1.jpg" alt="">
                </div>
                <div class="column right">
                    <div class="text">I'm Rafi Ahmed and I'm a <span class="typing-2"></span></div>
                    <p>I am a noob programming geek, a lover of freedom, and an enthusiast of technology. I studied Computer Science and Engineering (CSE) at Sonargao University. I love to do research works on machine learning and deep learning too. Besides web desiging & developing, I write articles. At the time of my study break, I try to create different projects which are academic and non-academic. I've also participated in different Project Shows, Programming Contests, and International Conferences. At my leisure, love to play games and read story books. I love music. I am very keen to do social work.</p>
                    <a href="https://drive.google.com/file/d/1Be2jXc4yDyu3euVeEP8Rdz8iUnxOBTpj/view?usp=share_link" target="_blank">Download CV</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-width">
            ...
            <div class="skills-content">
                <div class="column left">
                    ...
                    <a href="https://mhjohn22.github.io/eduford" target="_blank">Eduford</a>
                    <a href="https://mhjohn22.github.io/central" target="_blank">Central</a>
                    <a href="https://mhjohn22.github.io/topperr" target="_blank">Topperr</a>
                    <a href="https://mhjohn22.github.io/apical" target="_blank">Apical</a>
                    <a href="https://judgecoder.com/" target="_blank">Judgecoder</a>
                    ...
                    <div class="icons">
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Rafi Ahmed</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Dhaka, Banglesh</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">smrafi120@gmail.com</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="column right">
                    <div class="text">Feedback me</div>
                    <form action="#">
                        <div class="fields">
    ...
    <footer>
        <span>All rights reserved by  | <span class="far fa-copyright"></span> Rafi Ahmed <?php date('y'); ?> </span>
    </footer>
